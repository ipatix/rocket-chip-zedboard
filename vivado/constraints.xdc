...
#create_clock -period 20 [get_ports GCLK];  # Command should be testet!!
#set_property PACKAGE_PIN Y9 [get_ports {GCLK}];  # "GCLK"

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {uart_rtl_0_txd}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {uart_rtl_3_rxd}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {uart_rtl_1_txd}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {uart_rtl_2_txd}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {uart_rtl_3_txd}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {uart_rtl_0_rxd}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {uart_rtl_1_rxd}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {uart_rtl_2_rxd}];  # "JA9"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {greset}];  # "BTNC"
