...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/clk_wiz_0/clk_sys} Clk_slave {/clk_wiz_0/clk_sys} Clk_xbar {/clk_wiz_0/clk_sys} Master {/axi_full_address_con_0/m_axi} Slave {/hbm_0/SAXI_00} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins hbm_0/SAXI_00]
connect_bd_net [get_bd_pins proc_sys_reset_sys/peripheral_aresetn] [get_bd_pins hbm_0/AXI_00_ARESET_N]
